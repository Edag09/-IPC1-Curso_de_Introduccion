...
public class NodeMega {
    ...
    private NodeMega sig;

    public NodeMega(int correlativo, String nombre_pk, String tipo_pk, String region, int PS, int Ata, int Def, int Vel, int AtEsp, int DefEsp, String rareza, String direccion_imagen) {
    ...
    public NodeMega getSig() {
        return sig;
    }

    public void setSig(NodeMega sig) {
        this.sig = sig;
    }
